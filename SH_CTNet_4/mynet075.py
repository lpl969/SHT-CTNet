...
class StokenAttention(nn.Module):
    def __init__(self, dim, stoken_size, n_iter=1, num_heads=16, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        super().__init__()
        self.n_iter = n_iter
...
class mynet(nn.Module):
    def __init__(self, num_classes, in_ch=1):
        ...
        self.conv = nn.Conv2d(in_ch, 16, kernel_size=7, stride=1, padding=(3, 3))
